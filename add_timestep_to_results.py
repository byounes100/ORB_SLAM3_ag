...
results_file = 'f_dataset-CMU_collect1_mono.txt'
final_results_file = 'CMU_collect1_mono_openvins_est.txt'
with open(results_file) as f:
    contents = f.readlines()

timestamps_file = '/Users/alexpletta/SLAM/Project/ORB_SLAM3_ag/Examples/Monocular/CMU_TimeStamps/CMU_site_Oporto_clearing_2022_08_17_collect1_processed1_leftcamera.txt'
timestamps = []
